...
`cmest` implements seven causal mediation analysis approaches including
...
al. (2017)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5560424/), *the
g-formula approach* by [Robins
(1986)](https://www.sciencedirect.com/science/article/pii/0270025586900886),
and *The multistate approach for stochastic interventions on a time-to
event mediator in the presence of semi-competing risks* by [Valeri et
al. (2021)](https://arxiv.org/abs/2102.13252)
...
<th style="text-align: center;">multistate</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
Valeri L (2021). A multistate approach for mediation analysis in the
presence of semi-competing risks with application in cancer survival
disparities. arXiv.
